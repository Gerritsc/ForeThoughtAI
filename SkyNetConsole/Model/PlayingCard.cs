...
public class PlayingCard : ICard
{
    ...
    {
        info.AddValue("suit", this.suit, typeof(Suit));
        info.AddValue("value", this.value, typeof(int));
    }

    public PlayingCard(SerializationInfo info, StreamingContext context){
        this.suit = (Suit) info.GetValue("suit", typeof(Suit));
    ...
    public override bool Equals(object obj){
        ...
        return (this.value == ((PlayingCard)obj).value) && (this.suit == ((PlayingCard)obj).suit);
    }
}
